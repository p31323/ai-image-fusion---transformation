...
const translations: Record<Language, Translations> = {
    en: {
      ...
      // FIX: Updated API key error message to reference API_KEY.
      "errorApiKey": "API_KEY environment variable not set. Please add it to your environment configuration.",
    ...
    zh: {
      ...
      // FIX: Updated API key error message to reference API_KEY.
      "errorApiKey": "API_KEY 環境變數未設定。請將其新增至您的環境設定中。",
    ...
    ja: {
      ...
      // FIX: Updated API key error message to reference API_KEY.
      "errorApiKey": "API_KEY環境変数が設定されていません。環境設定に追加してください。",

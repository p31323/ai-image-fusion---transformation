...
const translations: Record<Language, Translations> = {
    en: {
      ...
      // Fix: Update API key error message to reference API_KEY as per guidelines.
      "errorApiKey": "API_KEY environment variable not set. Please add it to your project settings.",
    ...
    ja: {
      ...
      // Fix: Update API key error message to reference API_KEY as per guidelines.
      "errorApiKey": "API_KEY 環境変数が設定されていません。プロジェクト設定に追加してください。",

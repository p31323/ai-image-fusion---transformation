...
const translations: Record<Language, Translations> = {
    en: {
      ...
      // FIX: Updated error message to be generic for API_KEY, not VITE_API_KEY.
      "errorApiKey": "API_KEY environment variable not set. Please ensure it is configured correctly.",
    ...
    zh: {
      ...
      // FIX: Updated error message to be generic for API_KEY, not VITE_API_KEY.
      "errorApiKey": "API_KEY 環境變數未設定。請確保它已在伺服器上正確設定。",
    ...
    ja: {
      ...
      // FIX: Updated error message to be generic for API_KEY, not VITE_API_KEY.
      "errorApiKey": "API_KEY 環境変数が設定されていません。サーバーで正しく設定されていることを確認してください。",

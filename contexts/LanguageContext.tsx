...
const translations: Record<Language, Translations> = {
    en: {
      ...
      "errorApiKey": "API_KEY environment variable not set. Please add it in your Vercel project settings.",
    ...
    zh: {
      ...
      // FIX: Updated error message to reference API_KEY instead of VITE_API_KEY.
      "errorApiKey": "API_KEY 環境變數未設定。請在您的 Vercel 專案設定中新增它。",
    ...
    ja: {
      ...
      // FIX: Updated error message to reference API_KEY instead of VITE_API_KEY.
      "errorApiKey": "API_KEY環境変数が設定されていません。Vercelプロジェクト設定で追加してください。",
